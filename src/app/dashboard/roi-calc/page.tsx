    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white">Calcula cuanto deberias cobrar.</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">
            Define precios con una regla simple: costo total, margen deseado y ganancia esperada.
          </p>
        </div>
      ...
      <div className="p-8 bg-indigo-50 border border-indigo-100 rounded-[2rem] dark:bg-indigo-900/10 dark:border-indigo-800/50 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-5">
          ...
          <div>
            <p className="text-lg font-black text-slate-900 dark:text-white">Quieres ver todos tus analisis?</p>
            <p className="text-sm font-medium text-slate-500 dark:text-indigo-300/60">
              Gestiona, edita y exporta tus productos en el catalogo central.
            </p>
          </div>
        </div>
        <Link
