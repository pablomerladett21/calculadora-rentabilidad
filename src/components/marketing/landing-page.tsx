        ...
        <header className="flex items-center justify-between gap-4 rounded-3xl border border-white/60 bg-white/70 px-5 py-4 shadow-sm backdrop-blur dark:border-slate-800/70 dark:bg-slate-950/70">
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-black uppercase tracking-widest text-slate-600 transition hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300 dark:hover:bg-slate-900"
            >
              Entrar
            </Link>
            <Link
              href="/register?redirect=/dashboard"
              className="rounded-2xl bg-indigo-600 px-4 py-2.5 text-xs font-black uppercase tracking-widest text-white shadow-lg shadow-indigo-500/25 transition hover:bg-indigo-700"
            >
              Probar gratis
            </Link>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {highlights.map((item) => (
                <div
                  key={item}
                  className="rounded-2xl border border-white/70 bg-white/80 px-4 py-4 text-sm font-bold text-slate-700 shadow-sm dark:border-slate-800 dark:bg-slate-950/70 dark:text-slate-200"
                >
                  {item}
                </div>
              ))}
            ...
            <h2 className="mt-2 text-3xl font-black tracking-tight text-slate-950 dark:text-white">
              ...
              <div className="mt-8 rounded-[1.75rem] bg-slate-950 p-6 text-white dark:bg-slate-900">
                ...
                <div className="mt-3 flex items-end gap-2">
                  <span className="text-5xl font-black tracking-tight">USD 12</span>
